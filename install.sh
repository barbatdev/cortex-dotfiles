...
install_with_brew tmux tmux "tmux (multiplexor de terminal)"
install_with_brew zellij zellij "zellij (multiplexor remoto persistente)"
...
backup_if_exists "$HOME/.config/zellij/layouts/cortex.kdl"
...
create_symlink "$DOTFILES/zellij/layouts/cortex.kdl" "$HOME/.config/zellij/layouts/cortex.kdl"
