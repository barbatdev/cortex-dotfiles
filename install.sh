...
backup_if_exists "$HOME/.config/yabai/move-window-display"
backup_if_exists "$HOME/.config/yabai/focus-window-display"
backup_if_exists "$HOME/.config/yabai/focus-window-cycle"
backup_if_exists "$HOME/.config/yabai/swap-window-cycle"
...
chmod +x "$DOTFILES/yabai/yabairc" "$DOTFILES/yabai/move-window-display" "$DOTFILES/yabai/focus-window-display" "$DOTFILES/yabai/focus-window-cycle" "$DOTFILES/yabai/swap-window-cycle"
create_symlink "$DOTFILES/yabai/yabairc"           "$HOME/.config/yabai/yabairc"
create_symlink "$DOTFILES/yabai/move-window-display" "$HOME/.config/yabai/move-window-display"
create_symlink "$DOTFILES/yabai/focus-window-display" "$HOME/.config/yabai/focus-window-display"
create_symlink "$DOTFILES/yabai/focus-window-cycle" "$HOME/.config/yabai/focus-window-cycle"
create_symlink "$DOTFILES/yabai/swap-window-cycle" "$HOME/.config/yabai/swap-window-cycle"
