...
Claude Code and OpenCode keybindings are mostly app-native. This repo only keeps shell launch helpers; themes, statuslines, skills, agents, and orchestration live in `cortex`.
